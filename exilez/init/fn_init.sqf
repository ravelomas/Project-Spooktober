...
NightStartTime               = 16;               // Time at which it is night in hours
...
CqbDistance                  = 5;               // Minimal ditance for close quarter bonus
CqbBonus                     = 10;               // Respect for close quarter bonus at 1 meter
...
_Ryanzombieshealth			           = 0.85; 	 // Health, *(initial damage level 0 is no damage 1 is dead)
_Ryanzombieshealthdemon                = 0.25;	 // Health, *(initial damage level 0 is no damage 1 is dead)
...
_Ryanzombiesattackstrenth 	           = 0.0;	     // Attack strength *(Knockback strength) *(TYPO IS NORMAL)
_Ryanzombiesdamage 			           = 0.2;   // Attack damage *(% of players life per hit, 1 is 100%)
...
_ryanzombiesmovementspeeddemon         = 0.5;      //Animation speed for demons
_ryanzombiesmovementspeedspider        = 1.8;      //Animation speed for spider
_ryanzombiesmovementspeedcrawler       = 0.8;      //Animation speed for crawler
...
/* 1 Frequency */            300,                // time in seconds between each new zombie.
/* 2 Vest group */           Nothing,            // Vest function defined in ZVest.sqf
/* 3 Loot group */           Nothing,            // Loot function defined in ZLoot.sqf
/* 4 Zombie group */         MediumMix,          // Group function defined in ZClasses.sqf
...
/* 4  Spawn Delay */         3,                 // The delay between each zombie spawn right after the activation until the Max group size is reached.
/* 5  Respawn Delay */       300,                 // The respawn delay after the max group size was reached
